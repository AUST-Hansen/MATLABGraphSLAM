function [measurementTimestamps, rangeMeasurements, c_i_t,meas_ind,multibeamMeasurements,c_i_t_mb] = cleanMeasurements(timeSteps,multibeam,multibeamData,useMultibeam,imagenex,imagenexData,useImagenex,dvl,dvlData,useDVL,rangeSkipReson,rangeSkipImagenex,poseSkip)
   ...
   for i_time = 1:poseSkip:N
       ...
       for jj = 1:rangeSkipReson:multibeam.numBeams
          ...
          if (multibeamData(jj,i_time) ~= -17 && ~isnan(multibeamData(jj,i_time)) &&  multibeamData(jj,i_time) < multibeam.maxRange)
              ...
              c_i_t_mb(mbCounter,i_time) = j_validMBMeas;
